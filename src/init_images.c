...
/*   Updated: 2023/12/04 19:36:27 by dylmarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_image2(t_data *data)
{
	...
	data->sprites.exit_close.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.exit_close.bits_per,
			&data->sprites.exit_close.line_len,
	...
	data->sprites.exit_open.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.exit_open.bits_per,
			&data->sprites.exit_open.line_len,
	...
	data->sprites.player_back.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.player_back.bits_per,
			&data->sprites.player_back.line_len,
...
void	init_image3(t_data *data)
{
	...
	data->sprites.player_front.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.player_front.bits_per,
			&data->sprites.player_front.line_len,
	...
	data->sprites.player_left.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.player_left.bits_per,
			&data->sprites.player_left.line_len,
	...
	data->sprites.player_right.image_pix = mlx_get_data_addr(data->mlx,
			&data->sprites.player_right.bits_per,
			&data->sprites.player_right.line_len,
